...
class BaseMMSeg(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        print("BASE CLASS DEFINITION ARGS: ")
        print(kwargs)
        print("BASE image_size = {}".format(image_size))
        print("BASE crop_size = {}".format(crop_size))
        print("BASE split = {}".format(split))
        print("BASE normalization = {}".format(normalization))
        print("BASE STATS[normalization] = {}".format(STATS[normalization]))
        super().__init__()
    ...
    def get_gt_seg_maps(self):
        ...
        print("Type of dataset.img_infos : {}".format(type(dataset.img_infos)))
